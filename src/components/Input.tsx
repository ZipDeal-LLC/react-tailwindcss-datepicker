...
const Input: React.FC<{ inputClassName: string }> = ({ inputClassName }) => {
    ...
    const getClassName = useCallback(() => {
        ...
        return clsx({
            ["relative transition-all duration-300 py-2.5 pl-4 pr-10 w-full border border-gray-300 rounded-lg tracking-wide text-sm placeholder-gray-400 bg-white focus:ring"]:
                true,
            [border]: true,
